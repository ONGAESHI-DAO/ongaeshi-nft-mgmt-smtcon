...
describe("Stake Test", function () {
    ...
    describe("Stake", function () {
        ...
        it("Stake", async function () {
            ...
            expect(data.amount).to.equal(ethers.utils.parseEther("3000"));
            expect(data.depositDuration).to.equal(86400 * 30);
            expect(data2.amount).to.equal(ethers.utils.parseEther("100"));
            expect(data2.depositDuration).to.equal(86400 * 60);
        ...
        it("Withdraw", async function () {
            ...
            expect(data.depositDuration).to.equal(0);
            expect(data2.amount).to.equal(ethers.utils.parseEther("3000"));
            expect(data2.depositDuration).to.equal(86400 * 30);
            ...
            // withdraw all
            await stake.withdraw(2);
            await stake.withdraw(3);
            await stake.connect(accounts[1]).withdraw(1);
            await stake.connect(accounts[1]).withdraw(2);
            await stake.connect(accounts[1]).withdraw(3);
