...
async function main(treasuryAddress) {
    ...
    const TalenMatch = await hre.upgrades.deployProxy(talentMatchDeployer, [hre.ethers.constants.AddressZero, 3000, 3000, 4000, courseTokenEvent.address, treasuryAddress]);
